...
class App(superWindow):
    ...
    def weeklyReportUI(self, tab_='Weekly report'):
        ...
        seperator.grid(row=1, column=0, columnspan=10, padx=20, pady=20)
        ...
        self.sendEmailCheckbox.grid(row=2, column=0, padx=(20, 20), pady=20, sticky='w')
        ...
        self.produceTxtOutput.grid(row=2, column=1, padx=(20, 20), pady=20, sticky='w')
        ...
        self.generateWeeklyReportButton.grid(row=3, column=0, padx=(20, 20), pady=20, sticky='w')
        ...
        self.reportInfoLabel.grid(row=3, column=1, padx=(20, 20), pady=20, sticky='w')
