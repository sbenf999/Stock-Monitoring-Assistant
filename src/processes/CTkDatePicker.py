"""
CTkDatePicker is a custom date picker widget built using the CustomTkinter library. It provides a user-friendly interface for selecting dates, with both a text entry and a calendar popup for easy date selection.Author: Akascape
Link: https://github.com/maxverwiebe/CTkDatePicker/tree/main
Author: Max Verwiebe
"""
